public class Test11 {
	...
	public static void main(String[] args) {
		Test11.staticVoidMethodNoParams();
		int i1 = Test11.staticIntMethodNoParams();
		String s1 = Test11.staticStringMethodNoParams();
		Double d1 = Test11.staticDoubleMethodNoParams();
		Test11.staticVoidMethodTwoParams(10, 20);
		int i2 = Test11.staticIntMethodTwoParams(10, 20);
		...
		Test11.staticBooleanMethodNoParams();
		Test11.staticCharMethodNoParams();
		Test11.staticByteMethodNoParams();
		Test11.staticShortMethodNoParams();
	}
