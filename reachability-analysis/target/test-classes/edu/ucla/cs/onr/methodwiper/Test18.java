public class Test18 {
	...
	public static void main(String[] args) {
		Test18.staticVoidMethodNoParams();
		int i1 = Test18.staticIntMethodNoParams();
		String s1 = Test18.staticStringMethodNoParams();
		Double d1 = Test18.staticDoubleMethodNoParams();
		Test18.staticVoidMethodTwoParams(10, 20);
		int i2 = Test18.staticIntMethodTwoParams(10, 20);
		...
		Test18.staticBooleanMethodNoParams();
		Test18.staticCharMethodNoParams();
		Test18.staticByteMethodNoParams();
		Test18.staticShortMethodNoParams();
	}
