public class Test3 {
	...
	public static void main(String[] args) {
		Test3.staticVoidMethodNoParams();
		int i1 = Test3.staticIntMethodNoParams();
		String s1 = Test3.staticStringMethodNoParams();
		Double d1 = Test3.staticDoubleMethodNoParams();
		Test3.staticVoidMethodTwoParams(10, 20);
		int i2 = Test3.staticIntMethodTwoParams(10, 20);
		...
		Test3.staticBooleanMethodNoParams();
		Test3.staticCharMethodNoParams();
		Test3.staticByteMethodNoParams();
		Test3.staticShortMethodNoParams();
	}
