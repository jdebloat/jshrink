public class Test7 {
	...
	public static void main(String[] args) {
		Test7.staticVoidMethodNoParams();
		int i1 = Test7.staticIntMethodNoParams();
		String s1 = Test7.staticStringMethodNoParams();
		Double d1 = Test7.staticDoubleMethodNoParams();
		Test7.staticVoidMethodTwoParams(10, 20);
		int i2 = Test7.staticIntMethodTwoParams(10, 20);
		...
		Test7.staticBooleanMethodNoParams();
		Test7.staticCharMethodNoParams();
		Test7.staticByteMethodNoParams();
		Test7.staticShortMethodNoParams();
	}
