...
//        }
	...
	public void testJUnit4() {
		...
		CallGraphAnalysis runner = 
				new CallGraphAnalysis(lib_class_paths, app_class_paths, app_test_paths, new EntryPointProcessor(false, false, false,false, entryPoints),true);
		runner.run();
	}
	...
	public void testJeesite() {
		...
		CallGraphAnalysis runner = 
				new CallGraphAnalysis(lib_class_paths, app_class_paths, app_test_paths, new EntryPointProcessor(false, false, false,false, entryPoints),false);
		runner.run();
	}
